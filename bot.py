...
>>>>>>> 400bf0e7bc4845d519d753066de3450d34c937d0
...
=======
    ...
    game_list = parse_games(data)
    filename = csv_create(game_list)
    await client.say("Your csv file is being sent to your DMs")
    print("/deals_csv: " + filename)
    await client.send_file(author, filename)
>>>>>>> 400bf0e7bc4845d519d753066de3450d34c937d0
...
=======
    ...
    game_list = parse_games(data)
    print("/deals_spam")
    await client.say("Your game deals are being sent to your DMs right now")
    for game in game_list:
        await client.send_message(author, "-" * 120 + "\nDeal Link: " + game[11] + "\nTitle: " + game[0] + "\nStore: " + game[5] + "\nMSRP: " + game[6] + "\nSale Price: " + game[7] + "\nDiscount: " + game[8] + "\nDeal Rating: " + game[9])
        time.sleep(1)
>>>>>>> 400bf0e7bc4845d519d753066de3450d34c937d0
...
=======
    ...
    game_list = parse_games(data)
    filename = csv_create(game_list)
    await client.say("Your custom csv file for " + arg + " is being sent to your DMs")
    print(filename)
    await client.send_file(author, filename)
>>>>>>> 400bf0e7bc4845d519d753066de3450d34c937d0
...
=======
    ...
    for key in platforms:
        stores.append(key['storeName'])
    await client.send_message(author,"These are all the stores that our bot can check for:\n" + stores[0] + "\n" + stores[1] + "\n"+ stores[2] + "\n" + stores[3] + "\n" + stores[4] + "\n" + stores[5] + "\n" + stores[6] + "\n" + stores[7] + "\n" + stores[8] + "\n" + stores[9] + "\n" + stores[10] + "\n" + stores[11] + "\n" + stores[12] + "\n" + stores[13] + "\n" + stores[14] + "\n" + stores[15] + "\n" + stores[16] + "\n" + stores[17] + "\n" + stores[18] + "\n" + stores[19] + "\n" + stores[20] + "\n" + stores[21] + "\n" + stores[22] + "\n" + stores[23] + "\n" + stores[24])
>>>>>>> 400bf0e7bc4845d519d753066de3450d34c937d0
